...
$stag_db_name = 'db_omar1'; // Staging database name
$stag_user = 'omar1'; // Staging MySQL user
$stag_password = 'omar123'; // Staging MySQL password

// Production database configuration
$prod_db_name = 'db_omar2'; // Production database name
$prod_user = 'omar2'; // Production MySQL user
$prod_password = 'omar123'; // Production MySQL password
